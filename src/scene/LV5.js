class LV5 extends Phaser.Scene{
    constructor(){
        super("Lv5");
    }
    ...
    create(){
        ...
        this.enemy4 = new Fast(this, spawn6.x, spawn6.y, 'fast').play('fastMove').setOrigin(0.5);
        this.enemy5 = new Fast(this, spawn7.x, spawn7.y, 'fast').play('fastMove').setOrigin(0.5);
        this.enemy6 = new Fast(this, spawn8.x, spawn8.y, 'fast').play('fastMove').setOrigin(0.5);
