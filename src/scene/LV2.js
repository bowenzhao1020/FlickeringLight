class LV2 extends Phaser.Scene{
    ...
    create(){
        ...
        this.enemy0 = new Fast(this, spawn1.x, spawn1.y, 'fast').play('fastMove').setOrigin(0.5);
        this.enemy1 = new Fast(this, spawn2.x, spawn2.y, 'fast').play('fastMove').setOrigin(0.5);
        this.enemy2 = new Fast(this, spawn3.x, spawn3.y, 'fast').play('fastMove').setOrigin(0.5);
        this.enemy3 = new Fast(this, spawn4.x, spawn4.y, 'fast').play('fastMove').setOrigin(0.5);
        this.enemy4 = new Fast(this, spawn5.x, spawn5.y, 'fast').play('fastMove').setOrigin(0.5);
        this.enemy5 = new Fast(this, spawn6.x, spawn6.y, 'fast').play('fastMove').setOrigin(0.5);
        this.enemy6 = new Fast(this, spawn7.x, spawn7.y, 'fast').play('fastMove').setOrigin(0.5);
        this.enemy7 = new Fast(this, spawn8.x, spawn8.y, 'fast').play('fastMove').setOrigin(0.5);
