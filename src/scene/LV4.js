class LV4 extends Phaser.Scene{
    constructor(){
        super("Lv4");
    }
    ...
    create(){
        ...
        this.anims.create({
            key: 'slowMove',
            frames: this.anims.generateFrameNumbers('slow', { frames: [0, 1] }),
            frameRate: 10,
            repeat: -1
        })
        ...
        this.enemy0 = new Slow(this, spawn1.x, spawn1.y, 'slow').play('slowMove').setOrigin(0.5);
        this.enemy1 = new Slow(this, spawn2.x, spawn2.y, 'slow').play('slowMove').setOrigin(0.5);
        this.enemy2 = new Slow(this, spawn3.x, spawn3.y, 'slow').play('slowMove').setOrigin(0.5);
        this.enemy3 = new Slow(this, spawn4.x, spawn4.y, 'slow').play('slowMove').setOrigin(0.5);
        this.enemy4 = new Slow(this, spawn5.x, spawn5.y, 'slow').play('slowMove').setOrigin(0.5);
        this.enemy5 = new Slow(this, spawn6.x, spawn6.y, 'slow').play('slowMove').setOrigin(0.5);
        this.enemy6 = new Slow(this, spawn7.x, spawn7.y, 'slow').play('slowMove').setOrigin(0.5);
        this.enemy7 = new Slow(this, spawn8.x, spawn8.y, 'slow').play('slowMove').setOrigin(0.5);
